...
# Game Title
pygame.display.set_caption("sasta snake")
...
def plot_snake(gameWindow, yellow, snk_list, snake_size):
    for x, y in snk_list:
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("Game Over! Press Enter To retry", red, 100, 250)
